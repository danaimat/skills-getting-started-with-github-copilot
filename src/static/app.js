      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        const participantsHTML = details.participants.length
          ? `<ul class="participants-list">${details.participants
              .map((participant) => `<li class="participant-item">${participant}<button class="delete-participant" data-activity="${name}" data-email="${participant}" type="button" title="Remove participant">✕</button></li>`)
              .join("")}</ul>`
